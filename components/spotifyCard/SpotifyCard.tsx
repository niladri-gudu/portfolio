...
export default function SpotifyCard() {
  ...
  return (
    <div className="w-full p-5 rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-900/30 flex items-center justify-between group transition-all duration-300 hover:bg-neutral-100 dark:hover:bg-neutral-900/50">
      ...
      <div className="pr-2 sm:block">
        <svg 
          viewBox="0 0 24 24" 
          className="w-5 h-5 fill-neutral-300 dark:fill-neutral-700 group-hover:fill-[#1DB954] transition-colors duration-500"
        >
